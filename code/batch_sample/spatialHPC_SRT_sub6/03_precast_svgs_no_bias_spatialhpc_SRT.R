...
length(svgs_filt_sub6) #should be 2321
...
PRECASTObj_filt_sub6 <- PRECAST(PRECASTObj_filt_sub6, K=7)
...
# 2321 common variable genes selected

seuInt_filt_sub6 <- IntegrateSpaData(PRECASTObj_filt_sub6, species = "Human")
# An object of class Seurat 
# 2321 features across 28306 samples within 1 assay 
# Active assay: PRE_CAST (2321 features, 0 variable features)
